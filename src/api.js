...
export async function fetchSTRACDashboard(baseMonth, spanMonths = 3) {
  const url = `${SERVER_URL}/api/strac/dashboard?baseMonth=${encodeURIComponent(baseMonth)}&spanMonths=${encodeURIComponent(spanMonths)}`;
